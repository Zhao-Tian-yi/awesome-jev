...
Technical audit: **2026-09-21** · Stars snapshot: **2026-09-22T03:56:53Z** ([API sources](data/github-stars.json)). Unknown means the first-public date is unverified; stars are not a quality score.
...
| [yibie/awesome-jev](https://github.com/yibie/awesome-jev) | [1,028](https://github.com/yibie/awesome-jev/stargazers) | Unknown | English | Applications / Ecosystem | Application-domain catalogue with explicit curation and evidence caveats. |
